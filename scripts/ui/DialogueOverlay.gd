	...
	for dialogue_option_id: String in current_dialogue_state.dialogue_state_dialogue_option_object_ids:
		...
		if dialogue_option_data != null:
			...
			dialogue_option_button.init(
				...
				I18N.tr_data(dialogue_option_data.object_id, "dialogue_option_bbcode", dialogue_option_data.dialogue_option_bbcode),
				I18N.tr_data(dialogue_option_data.object_id, "dialogue_option_failed_validator_bbcode", dialogue_option_data.dialogue_option_failed_validator_bbcode),
