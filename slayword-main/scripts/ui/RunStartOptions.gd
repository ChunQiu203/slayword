...
func populate_run_start_options() -> void:
	...
	for i in mixed_option_count:
		...
		var option_bbcode: String = I18N.tr_data(upside_run_start_option_data.object_id, "run_start_option_bb_code", upside_run_start_option_data.run_start_option_bb_code) + ", " + I18N.tr_data(downside_run_start_option_data.object_id, "run_start_option_bb_code", downside_run_start_option_data.run_start_option_bb_code)
	...
	for i in min(COMPLETE_OPTION_COUNT, len(complete_option_ids)):
		...
		var option_bbcode: String = I18N.tr_data(complete_run_start_option_data.object_id, "run_start_option_bb_code", complete_run_start_option_data.run_start_option_bb_code)
